...
class Settings(BaseSettings):
    ...
    # Database — SQLite by default so fresh installs work without Docker
    database_url: str = "sqlite+aiosqlite:///polymarket_ai.db"
    database_echo: bool = False

    # Redis (optional — event bus falls back to in-process if unavailable)
